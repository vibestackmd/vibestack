...
if (Test-Path $installScript) {
    ...
    Write-Host ""
    wsl -d Ubuntu -- bash -c "curl -fsSL https://raw.githubusercontent.com/vibestackmd/vibestack/main/extras/dev-tools/install.sh | bash"
}
...
Write-Host "       curl -fsSL https://raw.githubusercontent.com/vibestackmd/vibestack/main/extras/dev-tools/install.sh | bash" -ForegroundColor DarkGray
Write-Host ""
