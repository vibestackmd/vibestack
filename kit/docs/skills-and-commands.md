...
- `/vibestack` — Set up VibeStack conventions for an existing project. Analyzes the codebase to fill out CLAUDE.md, Makefile, docs, and TODO.md with project-specific content. Run this after installing the kit into a repo.
